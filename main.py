...
#Лекторы
best_lecturer_1 = Lecturer('Iva', 'Pack')
best_lecturer_1.courses_attached += ['Python']

best_lecturer_2 = Lecturer('Alex', 'Hof')
best_lecturer_2.courses_attached += ['GIT']

best_lecturer_3 = Lecturer('Sam', 'Lee')
...
cool_reviewer_2 = Reviewer('Oskar', 'Wild')
cool_reviewer_2.courses_attached += ['Python']
cool_reviewer_2.courses_attached += ['GIT']
 #Студенты
student_1 = Student('Den', 'Sims')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ['Введение в программирование']

student_2 = Student('Rom', 'Mac')
student_2.courses_in_progress += ['GIT']
student_2.finished_courses += ['Введение в программирование']

student_3 = Student('Kate', 'Root')
...
print()
print()
#Cписок сравнения  рейтинга студентов
print(f'Результат сравнения студентов (по средним оценкам за ДЗ): '
      f'{student_1.name} {student_1.surname} < {student_2.name} {student_2.surname} = {student_1 > student_2}')
print()

#Cписок сравнения рейтинга лекторов
